...
public:
  ...
  /// Timestamp of the clone we will marginalize next, computed as the strict
  /// time-FIFO oldest clone (ignores any disparity-marg override). Used by the
  /// disparity policy itself to know what "oldest" is.
