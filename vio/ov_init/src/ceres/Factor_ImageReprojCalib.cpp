...
Factor_ImageReprojCalib::Factor_ImageReprojCalib(const Eigen::Vector2d &uv_meas_, double pix_sigma_, bool is_fisheye_)
    : Factor_ImageReprojCalib(uv_meas_, pix_sigma_, is_fisheye_, false) {}

Factor_ImageReprojCalib::Factor_ImageReprojCalib(const Eigen::Vector2d &uv_meas_, double pix_sigma_, bool is_fisheye_, bool is_ds_)
    : uv_meas(uv_meas_), pix_sigma(pix_sigma_), is_fisheye(is_fisheye_), is_ds(is_ds_) {
